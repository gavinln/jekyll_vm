...
run from the root directory (containing the Vagrantfile) of the project
It assumes that it is running on Windows and that Git has been installed
and uses the Git ssh executable to connect to the virtual machine
'''
import subprocess
import os
import _winreg
